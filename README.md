...
Переключатели в панели: ось X (по порядку коммитов / по реальному времени),
дата (автора / коммита), обработка мержей, высота строки, лимит коммитов.
...
| `GITGANTT_DEFAULT_COMMITS` | `2000` | лимит коммитов по умолчанию |
| `GITGANTT_MAX_COMMITS` | `20000` | жёсткий верхний предел |
| `GITGANTT_GIT_TIMEOUT_MS` | `60000` | таймаут вызова git |

## Ограничения текущей версии

- Мержи по умолчанию не несут изменений (так их видит `git log`); режим
  `--first-parent` доступен, но приписывает мержу все влитые правки.
