...
This app lives in the `docker-web-console/` subdirectory so it does not share `client/` / `server/` with the Git Gantt project at the repository root. Run all commands below from this directory.
